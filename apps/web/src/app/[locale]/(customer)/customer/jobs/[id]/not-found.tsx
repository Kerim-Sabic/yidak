...
interface CustomerJobNotFoundProps {
  params?: Promise<{ locale: string }>;
}

const CustomerJobNotFoundPage = async ({
  params,
}: CustomerJobNotFoundProps): Promise<React.JSX.Element> => {
...
export default CustomerJobNotFoundPage;
